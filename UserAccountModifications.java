...
/**
 * Project 5 
 * <p>Purdue University -- CS18000 -- Fall 2021 -- Project 5</p>
 *The class that stores the methods to edit and delete accounts. The edit method allows the user to change their password, 
 since the username serves as a unique identifier. The delete account allows the user to remove their account from the system,
 essentially removing it from the UserInfo.txt file. The testing done to ensure the delete method works include typing in the
 username to delete the account and ensuring that it has been cleared from the UserInfo.txt file. The testing done for the
 edit method includes changing the password and ensuring that the user file reflects the change that was made. The methods
 within this class were integrated to the user class.
 * @author Donna Prince 
